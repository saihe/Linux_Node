...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 17 } }

unless (defined &__GLIBC__) { sub __GLIBC__() { 2 } }

unless (defined &__GNUC_GNU_INLINE__) { sub __GNUC_GNU_INLINE__() { 1 } }

unless (defined &__GNUC_MINOR__) { sub __GNUC_MINOR__() { 8 } }

unless (defined &__GNUC_PATCHLEVEL__) { sub __GNUC_PATCHLEVEL__() { 5 } }

unless (defined &__GNUC_RH_RELEASE__) { sub __GNUC_RH_RELEASE__() { 11 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.8\.5\\\ 20150623\\\ \(Red\\\ Hat\\\ 4\.8\.5\-11\)\"" } }
